...
export function PortfolioPreviewHint({
  ...
  const categoryColor = categoryColors[category] || categoryColors.technical;
      ...
      >
        ...
        <div className="flex items-start justify-between gap-6 relative z-10">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-medium text-[var(--text-tertiary)] italic">
                  Public Node ID: {displayName.toLowerCase().replace(/\s+/g, '-')}
                </span>
              </div>
            </div>
          ...
          <div className="flex-shrink-0">
            ...
            >
              <span className="text-[10px] font-black text-[var(--text-tertiary)] absolute top-2 uppercase tracking-tighter">
                Load
              </span>
              <span
