...
import { GraduationCap, Calendar, FileText, Save, X } from 'lucide-react';
...
export function EducationForm({
  ...
  useEffect(() => {
    setValue('period', generatePeriod(startYear, endYear, isPresent));
  }, [startYear, endYear, isPresent]); // eslint-disable-line react-hooks/exhaustive-deps
    ...
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
      ...
      <section className="bg-[var(--bg-surface)] border border-[var(--border-subtle)] rounded-xl p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-[var(--text-tertiary)]">When did you study this program?</p>
          </div>
        </div>
      ...
      <div className="flex items-center justify-end gap-4 pt-6 border-t border-[var(--border-subtle)]">
        ...
        <Button
          ...
          disabled={!startYear || (!endYear && !isPresent) || !title || !description}
        >
